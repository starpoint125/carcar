...
/* @var $model backend\models\search\CartypeSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="cartype-search ibox-heading row search" style="margin-top: 5px;padding-top:5px">
    ...
    <?= $form->field($model, 'type_name', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
    ...
    <?= $form->field($model, 'updated_at', ['labelOptions'=>['class'=>'col-sm-4 control-label'], 'size'=>8, 'options'=>['class'=>'col-sm-3']]) ?>
