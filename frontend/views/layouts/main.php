...
<div class="branding branding-black" style='display:none;'>
...
<footer class="footer">
    <div class="footer-inner">
        <p style='display:none;'>
            <a href="#" title="Feehi CMS">Feehi CMS</a> <?= Yii::t('frontend', 'Copyright, all rights reserved') ?> © 2015-<?=date('Y')?>&nbsp;&nbsp;
        ...
        <p><?=Yii::$app->feehi->website_icp?>北京云信链科技有限公司技术提供!</p>
    </div>
</footer>
